...
% wash(A,B,C):- isdry(A,C),negated_gripperopen(B,C),holding(A,C),isdirty(A,C).
% ******************************
...
:- not body_literal(0,isdry,2,(0,2)).
:- not body_literal(0,holding,2,(0,2)).
:- not body_literal(0,isdirty,2,(0,2)).