...
% ********** SOLUTION **********
% Precision:1.00 Recall:1.00 TP:3 FN:0 TN:65 FP:0 Size:5
% placeinshelf(A,B,C,D):- holding(A,D),isshelfcolor(A,B,D),holdingside(A,D),negated_gripperopen(C,D).
% ******************************
...
type(placeinshelf,(obj,shelf,robot,ex_id)).
...
:- not body_literal(0,holdingside,2,(0,3)).
