...
% ********** SOLUTION **********
% Precision:1.00 Recall:1.00 TP:3 FN:0 TN:65 FP:0 Size:7
% painttoshelf(A,B,C,D):- negated_gripperopen(C,D),isclean(A,D),negated_isshelfcolor(A,B,D),holding(A,D),isdry(A,D),goal_isshelfcolor(A,B,D).
% ******************************
...
type(painttoshelf,(obj,shelf,robot,ex_id)).
...
:- not body_literal(0,isdry,2,(0,3)).
:- not body_literal(0,isclean,2,(0,3)).
