...
prop(unsat_pair,white,my_true_claim_made_by).
prop(unsat_pair,my_true_gameOver,my_true_control).
prop(unsat_pair,white,my_true_control).
prop(unsat_pair,white,my_true_gameOver).
prop(unsat_pair,noop,lay_claim).
prop(unsat_pair,lay_claim,end_game).
prop(unsat_pair,noop,end_game).
prop(unsat_pair,my_true_claim_made_by,black).
prop(unsat_pair,my_true_control,black).
prop(unsat_pair,my_true_gameOver,black).
