...
% ********** SOLUTION **********
% Precision:1.00 Recall:1.00 TP:4 FN:0 TN:64 FP:0 Size:4
% dry(A,B,C):- iswet(A,C),holding(A,C),negated_gripperopen(B,C).
% ******************************
...
:- not body_literal(0,holding,2,(0,2)).
:- not body_literal(0,iswet,2,(0,2)).
