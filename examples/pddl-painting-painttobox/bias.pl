...
% ********** SOLUTION **********
% Precision:1.00 Recall:1.00 TP:1 FN:0 TN:67 FP:0 Size:7
% painttobox(A,B,C,D):- goal_inbox(E,B,D),isclean(A,D),negated_gripperopen(C,D),negated_isboxcolor(E,B,D),holding(A,D),isdry(A,D).
% ******************************
...
type(painttobox,(obj,box,robot,ex_id)).
