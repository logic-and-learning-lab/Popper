...
class Constrain:
    ...
    def make_program_inclusion_rule(self, program, program_handle):
        literals = []
        ...
        yield Constraint('inclusion rule', Literal('included_program', (program_handle,)), tuple(literals))
